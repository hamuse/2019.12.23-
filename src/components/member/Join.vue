...
<div>
  <div id="host-header">
        ...
        <span><input type="text" id="hostId" name="hostId" maxlength="20" value=""></span>
        </fieldset>
        <fieldset>
        <legend>패스워드 입력 </legend>
        <input type="pw" id="userPw" name="hostPw" maxlength="20" autocomplete="off">
        ...
        <div><input type="text" id="hostName" name="hostName" maxlength="20" value=""></div>
        </fieldset>
        <fieldset>
        <legend>닉네임 입력 </legend>
        <div><label for="nickName">닉네임</label></div>
        <div><input type="text" id="nickName" name="nickName" maxlength="20" value=""></div>
        </fieldset>
        <fieldset>
